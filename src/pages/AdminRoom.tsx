...
export function AdminRoom() {
  ...
  // const { user } = useAuth();
  const { titleRoom, questions } = useRoom(params.id);

  const handleClosedRoom = async () => {
  ...
  const handleQuestionHighlighted = async (questionId: string) =>
    await database
      .ref(`rooms/${params.id}/questions/${questionId}`)
                ...
                <>
                  <button
                    ...
                    className={`answered-button ${
                      question.isAnswered ? "answered-active" : ""
                    }`}
                  ...
                  <button
                    ...
                    className={`highlighted-button ${
                      question.isHighLighted ? "highlighted-active" : ""
                    }`}
                    onClick={() => handleQuestionHighlighted(question.id)}
                  >
                    <svg
                      width="24"
                      height="24"
